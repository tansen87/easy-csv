...
export const zhDialog = {
  ...
  splitLines: "按行拆分",
  linesPerFile: "每个文件行数",
  linesPerFileHint: "每个输出文件最多包含的行数",
  splitLinesStart: "开始拆分",
  splitting: "拆分中...",
  splitLinesLastResult: "上次按行拆分",
  splitLinesFileCount: "文件数",
  splitLinesTotalRows: "总行数",
  splitLinesHeaderCopied: "已复制表头",
  splitLinesNoResult:
