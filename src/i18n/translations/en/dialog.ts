...
export const enDialog = {
  ...
  linesPerFileHint: "Rows per output file",
  splitLinesStart: "Split",
  splitting: "Splitting...",
  splitLinesLastResult: "Last line split",
  splitLinesFileCount: "Files",
  splitLinesTotalRows: "Total rows",
  splitLinesHeaderCopied: "header copied",
  splitLinesNoResult:
