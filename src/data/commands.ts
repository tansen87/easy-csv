  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        name: "left",
        type: "flag",
        description: "Do an 'outer left' join",
        required: false,
        default: false,
      },
      {
        name: "right",
        type: "flag",
        description: "Do an 'outer right' join",
        required: false,
        default: false,
      },
      {
        name: "full",
        type: "flag",
        description: "Do a 'full outer' join",
        required: false,
        default: false,
      },
      {
        name: "semi",
        type: "flag",
        description: "Only keep rows of left file matching a row in right file",
        required: false,
        default: false,
      },
      {
        name: "anti",
        type: "flag",
        description: "Only keep rows of left file not matching a row in right file",
        required: false,
        default: false,
      },
      {
        name: "cross",
        type: "flag",
        description: "Return the cartesian product of the given CSV files",
        required: false,
        default: false,
      },
      {
