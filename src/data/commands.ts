    ...
    parameters: [
      {
        name: "chart-type",
        type: "string",
        description: "Type of chart to create. Can be \"line\", \"scatter\", \"bar\", or \"histogram\"",
        descriptionCn: "要创建的图表类型,可以是 \"line\"、\"scatter\"、\"bar\" 或 \"histogram\"",
        required: true,
        default: "line",
      },
      {
      ...
      },
      {
        name: "y",
        type: "string",
        description: "(required for line, scatter, bar; optional for histogram)",
