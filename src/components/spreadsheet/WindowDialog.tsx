...
export function WindowDialog({
  ...
  return (
    <div
      className="fixed bg-card border rounded-lg shadow-xl z-50 w-[360px]"
      style={{
        left: Math.min(windowDialog.x, window.innerWidth - 420),
        top: Math.min(windowDialog.y, window.innerHeight - 450),
      }}
